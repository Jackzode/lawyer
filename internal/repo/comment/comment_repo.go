...
func NewCommentRepo(DB *xorm.Engine, Cache *redis.Client, uniqueIDRepo unique.UniqueIDRepo) comment.CommentRepo {
	return &commentRepo{
		DB:           DB,
		Cache:        Cache,
...
func NewCommentCommonRepo(DB *xorm.Engine, Cache *redis.Client, uniqueIDRepo unique.UniqueIDRepo) comment_common.CommentCommonRepo {
	return &commentRepo{
		DB:           DB,
		Cache:        Cache,
		uniqueIDRepo: uniqueIDRepo,
