...
type AddConfigReq struct {
	...
	// the config value, custom data structures and utils
	Value string `validate:"omitempty,gt=0,lte=128" comment:"the config value, custom data structures and utils" json:"value"`
}
...
type GetConfigListReq struct {
	...
	// the config value, custom data structures and utils
	Value string `validate:"omitempty,gt=0,lte=128" comment:"the config value, custom data structures and utils" form:"value"`
}
