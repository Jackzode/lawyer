...
func NewUserNotificationConfigService() *UserNotificationConfigService {
...
func (us *UserNotificationConfigService) UpdateUserNotificationConfig(
	...
	err = repo.UserNotificationConfigRepo.Save(ctx,
...
func (us *UserNotificationConfigService) SetDefaultUserNotificationConfig(ctx context.Context, userIDs []string) (
	err error) {
	return repo.UserNotificationConfigRepo.Add(ctx, userIDs,
...
func (us *UserNotificationConfigService) CheckEnable(
	...
	conf, exist, err := repo.UserNotificationConfigRepo.GetByUserIDAndSource(ctx, userID, source)
	if err != nil {
		return false, err
	}
	if !exist {
